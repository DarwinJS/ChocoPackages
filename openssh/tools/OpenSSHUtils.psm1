...
function Fix-HostSSHDConfigPermissions
{
    param (
        ...
        (get-itemproperty "hklm:software\microsoft\windows nt\currentversion" -Name CurrentVersion).CurrentVersion -gt '6.1'
        {
...
Write-Host "$($psversiontable | ft Name,Value | out-string)"
