...
$packageArgs = @{
  ...
  url           = 'https://github.com/PowerShell/Win32-OpenSSH/releases/download/4_5_2016/OpenSSH-Win32.zip'
  url64bit      = 'https://github.com/PowerShell/Win32-OpenSSH/releases/download/4_5_2016/OpenSSH-Win64.zip'

  checksum      = '736FF9E2D4A655B54D58664F67C3AD88'
  checksumType  = 'md5'
  checksum64    = 'E4B87628F0FCCD95EE99F940147E3245'
  checksumType64= 'md5'
}
...
If ($SSHServerFeature)
{
  ...
  New-Service -Name sshd -BinaryPathName "$TargetFolder\sshd.exe" -Description "SSH Deamon" -StartupType Automatic | Out-Null
